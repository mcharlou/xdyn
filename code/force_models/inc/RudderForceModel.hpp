...
class RudderForceModel : public ForceModel
{
    public:
        ...
        Vector6d get_rudder_force(const BodyStates& states, const double t, const EnvironmentAndFrames& env, const std::map<std::string,double>& commands, const double T) const;
